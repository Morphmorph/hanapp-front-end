...
SET time_zone = "+00:00";
CREATE DATABASE IF NOT EXISTS `id20212380_mydb` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `id20212380_mydb`;
...
ALTER TABLE `schedule`
  ADD CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`applicantID`) REFERENCES `applicant` (`applicantID`) ON DELETE CASCADE ON UPDATE CASCADE;
