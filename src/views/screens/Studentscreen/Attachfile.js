...
var Data ={
 ...
 formData.append('cor',{type:inputs.CoR.mimeType,uri:inputs.CoR.uri,name:inputs.CoR.name})
 formData.append('school_id',{type:inputs.SchoolID.mimeType,uri:inputs.SchoolID.uri,name:inputs.SchoolID.name})
 formData.append('cov_let',{type:inputs.CovLet.mimeType,uri:inputs.CovLet.uri,name:inputs.CovLet.name})
...
axiosRequest.post('auth/apply/',formData,config)
      .then((response) => {
